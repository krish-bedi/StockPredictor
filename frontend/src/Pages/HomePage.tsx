    ...
    <>
      ...
      <WavyHero className="w-screen">
        <div className="h-92v bg-transparent">
          <div className="mx-auto max-w-7xl pt-24 sm:pt-[10rem]">
              ...
              <section className="px-6 sm:text-center md:mx-auto md:max-w-2xl lg:col-span-6 lg:flex lg:items-center lg:text-left">
                <div className="space-y-8">
                  <header className="space-y-4">
                    ...
                    <p className="font-light text-base text-gray-100 sm:mt-5 sm:text-xl lg:text-lg xl:text-xl">
                      StockPredictor is designed to provide advanced market
                      trend predictions and investment insights. By utilizing
                      machine learning algorithms, StockPredictor analyzes
                      historical market data to forecast future trends, helping
                      users make data-driven investment decisions.
                    </p>
                  </header>
